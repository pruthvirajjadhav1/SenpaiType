...
var theme = "dark";
  ...
  const projectsection = document.getElementsByClassName('yellow');
  ...
  function setLight() {
    ...
    for (let i = 0; i < projectsection.length; i++) {
        projectsection[i].style.setProperty("color","#ffd369");
      }
  ...
  function setDark() {
    root.style.setProperty("--bs-dark", "rgba(224, 219, 219, 0.9)");
